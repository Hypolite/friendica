...
function db_definition() {
	...
	$database["attach"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"edited" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["cache"] = array(
			"fields" => array(
					...
					"updated" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					),
			"indexes" => array(
					"PRIMARY" => array("k"),
	...
	$database["contact"] = array(
			"fields" => array(
					...
					"last-update" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"success_update" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"failure_update" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"name-date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"uri-date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"avatar-date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"term-date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"last-item" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["event"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"edited" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"start" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"finish" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["gcontact"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"updated" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					"last_contact" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					"last_failure" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					"location" => array("type" => "varchar(255)", "not null" => "1", "default" => ""),
					"about" => array("type" => "text"),
					"keywords" => array("type" => "text"),
					"gender" => array("type" => "varchar(32)", "not null" => "1", "default" => ""),
	...
	$database["gserver"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"last_poco_query" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					"last_contact" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					"last_failure" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					),
			"indexes" => array(
	...
	$database["intro"] = array(
			"fields" => array(
					...
					"datetime" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"blocked" => array("type" => "tinyint(1)", "not null" => "1", "default" => "1"),
	...
	$database["item"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"edited" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"commented" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"received" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"changed" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["locks"] = array(
			"fields" => array(
					...
					"created" => array("type" => "datetime", "default" => "1000-01-01 00:00:00"),
					),
			"indexes" => array(
					"PRIMARY" => array("id"),
					)
	...
	$database["mailacct"] = array(
			"fields" => array(
					...
					"pubmail" => array("type" => "tinyint(1)", "not null" => "1", "default" => "0"),
					"last_check" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					),
			"indexes" => array(
					"PRIMARY" => array("id"),
					)
	...
	$database["notify"] = array(
			"fields" => array(
					...
					"url" => array("type" => "varchar(255)", "not null" => "1", "default" => ""),
					"photo" => array("type" => "varchar(255)", "not null" => "1", "default" => ""),
					"date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["profile"] = array(
			"fields" => array(
					...
					"howlong" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["push_subscriber"] = array(
			"fields" => array(
					...
					"last_update" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["queue"] = array(
			"fields" => array(
					...
					"network" => array("type" => "varchar(32)", "not null" => "1", "default" => ""),
					"created" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"last" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["user"] = array(
			"fields" => array(
					...
					"register_date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"login_date" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					...
					"account_expires_on" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					"expire_notification_sent" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
	...
	$database["workerqueue"] = array(
			"fields" => array(
					...
					"executed" => array("type" => "datetime", "not null" => "1", "default" => "1000-01-01 00:00:00"),
					),
			"indexes" => array(
					"PRIMARY" => array("id"),
					"created" => array("created"),
